...
contract Lottery is Ownable {
    ...
    /// @notice Address of current prize winner as string
    ...
    function closeLottery() external returns(uint256 winnerAddress){
    ...
    /// @notice Returns address of current winner, if any, then resets winner
    function getWinner() external view returns (uint256 currentWinner){
        currentWinner = uint(uint160(winner)) ;
        //winner = address(0);
